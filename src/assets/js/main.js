...
const orbitRads = [775, 700, 625, 550, 475, 400, 325, 250];

const maxOrbitRadius = orbitRads[0];
...
textPaths.forEach((textPath, index) => {
    ...
    const currentOrbitRadius = orbitRads[index];

    const currentDuration =
        minAnimDuration + (currentOrbitRadius / maxOrbitRadius) * (maxAnimDuration - minAnimDuration);
